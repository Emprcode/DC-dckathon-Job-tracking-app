...
const approvedList = allJob.filter(item=>
  
item.status==="approved"
  
)
const pendingList = allJob.filter(item=>
  
item.status==="pending"
  
)
const rejectedList = allJob.filter(item=>
  
item.status==="rejected"
  
)
const wantToApplyList = allJob.filter(item=>
  
item.status==="wantToApply"
